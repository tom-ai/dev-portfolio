...
export default function Header() {
  ...
  return (
    <header className="py-12 md:py-12 lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24">
      <div>
        <h1 className={`text-4xl font-bold tracking-tighter md:text-5xl`}>
          <Link href={"/"}>Tom Harris</Link>
        </h1>
        <h2 className={`mt-3 text-lg font-medium tracking-tight md:text-xl`}>
          Software Developer
        </h2>
      ...
      <ul className="mt-8 flex gap-3">
        <li>
          <a
            rel="noreferrer"
            className="fill-stone-800 transition delay-100 duration-200 ease-in-out hover:-translate-y-1 hover:scale-110 hover:opacity-70 dark:fill-stone-50"
            href="https://github.com/tom-ai"
          >
            <svg
        ...
        <li>
          <a
            rel="noreferrer"
            className="fill-stone-800 transition delay-100 duration-200 ease-in-out hover:-translate-y-1 hover:scale-110 hover:opacity-70 dark:fill-stone-50"
            href="https://www.linkedin.com/in/tom-ai/"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              x="0px"
        ...
        <li>
          <a
            rel="noreferrer"
            className="fill-stone-800 transition delay-100 duration-200 ease-in-out hover:-translate-y-1 hover:scale-110 hover:opacity-70 dark:fill-stone-50"
            href="https://www.instagram.com/tommysax/"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              x="0px"
